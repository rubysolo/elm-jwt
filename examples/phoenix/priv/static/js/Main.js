...
var _user$project$Base64$partitionBits = function (list) {
	...
	return A2(
		...
		A2(_user$project$BitList$partition, 6, list_));
};
...
var _user$project$Base64$decode = function (s) {
	if (!_user$project$Base64$isValid(s)) {
...
var _user$project$Jwt$createRequest = F5(
	function (method, token, url, dec, body) {
		return _elm_lang$http$Http$request(
			{
				method: method,
				headers: _elm_lang$core$Native_List.fromArray(
					[
						A2(_elm_lang$http$Http$header, 'Content-type', 'application/json'),
						A2(
...
var _user$project$Jwt$get = F3(
	function (token, url, dec) {
		return A5(_user$project$Jwt$createRequest, 'GET', token, url, dec, _elm_lang$http$Http$emptyBody);
	});
var _user$project$Jwt$post = F5(
	function (msgCreator, token, dec, url, body) {
		return A2(
			_elm_lang$http$Http$send,
			msgCreator,
			A5(_user$project$Jwt$createRequest, 'POST', token, url, dec, body));
	});
var _user$project$Jwt$put = F5(
	function (msgCreator, token, dec, url, body) {
		return A2(
			_elm_lang$http$Http$send,
			msgCreator,
			A5(_user$project$Jwt$createRequest, 'PUT', token, url, dec, body));
	});
var _user$project$Jwt$authenticate = F4(
	function (msgCreator, url, dec, credentials) {
		return A2(
			_elm_lang$http$Http$send,
			msgCreator,
			A3(
...
var _user$project$Jwt$TokenDecodeError = function (a) {
	return {ctor: 'TokenDecodeError', _0: a};
};
var _user$project$Jwt$TokenProcessingError = function (a) {
...
var _user$project$Jwt$fixlength = function (s) {
	...
	switch (_p1) {
		...
		default:
			return _elm_lang$core$Result$Err(
				_user$project$Jwt$TokenProcessingError('Wrong length'));
	}
};
var _user$project$Jwt$decodeToken = F2(
	function (dec, token) {
		var f1 = A2(
			_elm_lang$core$String$split,
			'.',
			_user$project$Jwt$unurl(token));
...
var _user$project$Jwt$TokenNotAccepted = {ctor: 'TokenNotAccepted'};
...
var _user$project$Jwt$promote401 = F2(
	function (token, err) {
		var defaultError = _elm_lang$core$Task$succeed(
			_elm_lang$core$Result$Err(
				_user$project$Jwt$HttpError(err)));
		var _p5 = err;
		if (_p5.ctor === 'BadStatus') {
			return _elm_lang$core$Native_Utils.eq(_p5._0.status.code, 401) ? A2(
				_elm_lang$core$Task$andThen,
				function (t) {
					var _p6 = A2(_user$project$Jwt$isExpired, t, token);
					if (_p6.ctor === 'Ok') {
						if (_p6._0 === true) {
							return _elm_lang$core$Task$succeed(
								_elm_lang$core$Result$Err(_user$project$Jwt$TokenExpired));
						} else {
							return _elm_lang$core$Task$succeed(
								_elm_lang$core$Result$Err(_user$project$Jwt$TokenNotAccepted));
						}
					} else {
						return _elm_lang$core$Task$succeed(
				...
				_elm_lang$core$Time$now) : defaultError;
		} else {
			return defaultError;
		}
	});
var _user$project$Jwt$get_ = F3(
	function (token, url, dec) {
		return A2(
			_elm_lang$core$Task$onError,
			_user$project$Jwt$promote401(token),
			A2(
				_elm_lang$core$Task$map,
				_elm_lang$core$Result$Ok,
				_elm_lang$http$Http$toTask(
					A5(_user$project$Jwt$createRequest, 'GET', token, url, dec, _elm_lang$http$Http$emptyBody))));
	});

var _user$project$Decoders$dataDecoder = A2(_elm_lang$core$Json_Decode$field, 'data', _elm_lang$core$Json_Decode$string);
var _user$project$Decoders$tokenStringDecoder = A2(_elm_lang$core$Json_Decode$field, 'token', _elm_lang$core$Json_Decode$string);
var _user$project$Decoders$JwtToken = F4(
	function (a, b, c, d) {
		return {id: a, username: b, iat: c, expiry: d};
	});
var _user$project$Decoders$nodeDecoder = A5(
...
var _user$project$Decoders$phoenixDecoder = A5(
	_elm_lang$core$Json_Decode$map4,
	_user$project$Decoders$JwtToken,
	A2(_elm_lang$core$Json_Decode$field, 'aud', _elm_lang$core$Json_Decode$string),
	A2(_elm_lang$core$Json_Decode$field, 'aud', _elm_lang$core$Json_Decode$string),
	A2(_elm_lang$core$Json_Decode$field, 'iat', _elm_lang$core$Json_Decode$int),
	A2(_elm_lang$core$Json_Decode$field, 'exp', _elm_lang$core$Json_Decode$int));
var _user$project$Decoders$tokenDecoder = _elm_lang$core$Json_Decode$oneOf(
	_elm_lang$core$Native_List.fromArray(
		[_user$project$Decoders$nodeDecoder, _user$project$Decoders$phoenixDecoder]));

var _user$project$App$Model = F4(
	function (a, b, c, d) {
		return {uname: a, pword: b, token: c, msg: d};
	});
var _user$project$App$init = {
	ctor: '_Tuple2',
	_0: A4(_user$project$App$Model, 'testuser', 'testpassword', _elm_lang$core$Maybe$Nothing, ''),
	_1: _elm_lang$core$Platform_Cmd$none
};
var _user$project$App$Pword = {ctor: 'Pword'};
var _user$project$App$Uname = {ctor: 'Uname'};
var _user$project$App$InvalidTokenResult = function (a) {
	return {ctor: 'InvalidTokenResult', _0: a};
};
var _user$project$App$tryWithInvalidToken = A2(
	_elm_lang$core$Task$perform,
	_user$project$App$InvalidTokenResult,
	A3(_user$project$Jwt$get_, 'invalidToken', '/api/data', _user$project$Decoders$dataDecoder));
var _user$project$App$GetResult = function (a) {
	return {ctor: 'GetResult', _0: a};
};
var _user$project$App$tryToken = function (token) {
	return A2(
		_elm_lang$core$Task$perform,
		_user$project$App$GetResult,
		A3(_user$project$Jwt$get_, token, '/api/data', _user$project$Decoders$dataDecoder));
};
var _user$project$App$Auth = function (a) {
	return {ctor: 'Auth', _0: a};
};
var _user$project$App$submitCredentials = function (model) {
	return A4(
		_user$project$Jwt$authenticate,
		_user$project$App$Auth,
		'/sessions',
		_user$project$Decoders$tokenStringDecoder,
		_elm_lang$core$Json_Encode$object(
			_elm_lang$core$Native_List.fromArray(
				[
					...
					ctor: '_Tuple2',
					_0: 'username',
					_1: _elm_lang$core$Json_Encode$string(model.uname)
				},
					{
					ctor: '_Tuple2',
					_0: 'password',
					_1: _elm_lang$core$Json_Encode$string(model.pword)
				}
				])));
};
		...
		switch (_p0.ctor) {
			...
			case 'Submit':
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: _user$project$App$submitCredentials(model)
				};
			case 'TryToken':
				var _p3 = model.token;
				if (_p3.ctor === 'Just') {
					return A2(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_user$project$App$tryToken(_p3._0)
							]));
				} else {
					return A2(
						_elm_lang$core$Platform_Cmd_ops['!'],
			...
			case 'TryWithInvalidToken':
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{msg: 'Contacting server...'}),
					_1: _user$project$App$tryWithInvalidToken
				};
			case 'Auth':
				if (_p0._0.ctor === 'Ok') {
					return A2(
					...
					return A2(
						...
						_elm_lang$core$Native_Utils.update(
							model,
							{
								msg: _elm_lang$core$Basics$toString(_p0._0._0)
							}),
						_elm_lang$core$Native_List.fromArray(
							[]));
				}
					...
					if (_p4.ctor === 'TokenExpired') {
						...
						return A2(
							...
							_elm_lang$core$Native_Utils.update(
								model,
								{
									msg: _elm_lang$core$Basics$toString(_p5)
								}),
							_elm_lang$core$Native_List.fromArray(
								[]));
					}
...
var _user$project$App$TryWithInvalidToken = {ctor: 'TryWithInvalidToken'};
var _user$project$App$TryToken = {ctor: 'TryToken'};
var _user$project$App$Submit = {ctor: 'Submit'};
var _user$project$App$FormInput = F2(
	function (a, b) {
		return {ctor: 'FormInput', _0: a, _1: b};
	});
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('elm-jwt with Phoenix backend')
					])),
				A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('username = testuser, password = testpassword')
					])),
				A2(
				_elm_lang$html$Html$div,
				_elm_lang$core$Native_List.fromArray(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Events$onSubmit(_user$project$App$Submit),
									...
									[
										...
										_elm_lang$core$Native_List.fromArray(
											[
												...
												_elm_lang$core$Native_List.fromArray(
													[
														_elm_lang$html$Html_Attributes$for('uname')
													]),
												_elm_lang$core$Native_List.fromArray(
													[
												...
												_elm_lang$core$Native_List.fromArray(
													[
														...
														_user$project$App$FormInput(_user$project$App$Uname)),
														_elm_lang$html$Html_Attributes$class('form-control'),
														_elm_lang$html$Html_Attributes$value(model.uname)
													]),
												_elm_lang$core$Native_List.fromArray(
													[]))
											])),
										...
										_elm_lang$core$Native_List.fromArray(
											[
												...
												_elm_lang$core$Native_List.fromArray(
													[
														_elm_lang$html$Html_Attributes$for('pword')
													]),
												_elm_lang$core$Native_List.fromArray(
													[
												...
												_elm_lang$core$Native_List.fromArray(
													[
														_elm_lang$html$Html_Events$onInput(
														_user$project$App$FormInput(_user$project$App$Pword)),
														_elm_lang$html$Html_Attributes$class('form-control'),
														_elm_lang$html$Html_Attributes$value(model.pword)
													]),
												_elm_lang$core$Native_List.fromArray(
													[]))
											])),
										...
										_elm_lang$core$Native_List.fromArray(
											[
												_elm_lang$html$Html_Attributes$type_('submit'),
				...
				if (_p6.ctor === 'Nothing') {
					...
					var token = A2(_user$project$Jwt$decodeToken, _user$project$Decoders$tokenDecoder, _p6._0);
					return A2(
						_elm_lang$html$Html$div,
						_elm_lang$core$Native_List.fromArray(
							[]),
							...
							[
								...
								_elm_lang$core$Native_List.fromArray(
									[
										...
										_elm_lang$core$Basics$toString(token))
									])),
								A2(
								_elm_lang$html$Html$button,
								_elm_lang$core$Native_List.fromArray(
									[
										...
										_elm_lang$html$Html_Events$onClick(_user$project$App$TryToken)
									]),
								_elm_lang$core$Native_List.fromArray(
									[
										_elm_lang$html$Html$text('Try token')
									])),
								A2(
								_elm_lang$html$Html$button,
								_elm_lang$core$Native_List.fromArray(
									[
										...
										_elm_lang$html$Html_Events$onClick(_user$project$App$TryWithInvalidToken)
									]),
								_elm_lang$core$Native_List.fromArray(
									[
										_elm_lang$html$Html$text('Try bad token')
									])),
								A2(
								_elm_lang$html$Html$p,
								_elm_lang$core$Native_List.fromArray(
								...
								_elm_lang$core$Native_List.fromArray(
									[
										_elm_lang$html$Html$text('Wait 30 seconds and try again too')
									]))
							]));
				}
			}(),
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text(model.msg)
					]))
			]));
};
